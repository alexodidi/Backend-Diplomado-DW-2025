...
| GET    | `/api/citas/mis-citas`       | Ver las citas asignadas por el usuario      | SI            | admin, usuario|
| DELETE | `/api/citas/mis-citas/:id`   | Elimina la asignación de la cita al usuario | SI            | admin, usuario|
| POST   | `/api/citas`                 | Crear nueva cita médica                     | SI            | admin, usuario|
| DELETE | `/api/citas/:id`             | Elimina la cita disponible o asignada       | SI            | admin         |
| GET    | `/api/citas/admin`           | Ver todas las listas                        | SI            | admin         |
| POST   | `/api/citas/asignar/:id`     | Asignar una cita al usuario autenticado     | SI            | admin, usuario|
